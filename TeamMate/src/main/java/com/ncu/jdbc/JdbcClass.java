...
public class JdbcClass implements JdbcInterface{
	...
	public void Adduser(UserModel usermodel) {
		...
		jdbc.update(insertquery,new Object[]{usermodel.getFname(),usermodel.getLname(),usermodel.getAge(),usermodel.getEmail(),usermodel.getPassword(),usermodel.getUser_position()});
	}
